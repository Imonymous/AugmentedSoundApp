...
AudioRecorder::AudioRecorder(AudioDeviceManager& sharedDeviceManager)  :    deviceManager(sharedDeviceManager),
...
void AudioRecorder::startRecording(String filePath, bool internalCallback)
{    
...
void AudioRecorder::writeBuffer(float **buffer, int blockSize)
{
    const ScopedLock sl (writerLock);
